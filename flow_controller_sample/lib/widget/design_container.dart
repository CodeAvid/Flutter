  ...
  Widget build(BuildContext context) {
    return Container(
        padding: EdgeInsets.symmetric(
            vertical: 16.0, horizontal: DesignHorizontalMargin.MARGIN),
        child: child,
        decoration: BoxDecoration(color: Design.colorWhite, boxShadow: [
          BoxShadow(
...
class _DesignScaffoldState extends State<DesignScaffold> {
  ...
  Widget _createScrollView() {
    return Expanded(
      ...
      _createPinnedAppBar(),
      SliverList(delegate: SliverChildBuilderDelegate(_createContentBuilder()))
    ]));
  }
    ...
    return Padding(
        ...
        child: IconButton(
            icon: Icon(Icons.arrow_back,
                size: 24.0, color: Design.colorNeutral.shade900),
            onPressed: () {
...
enum DesignAppBarLeftButton { NONE, BACK }
